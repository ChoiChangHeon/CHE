...
<div class="sect">
	<div class="part">
		<aside>
			<ul class="lnb-tabs">
				<li class="lnb-item"><a class="nav-link active" data-toggle="tab" href="#tab-1" data-bs-target="#tab-1">내 정보 수정</a></li>
				<li class="lnb-item"><a class="nav-link" data-toggle="tab" href="#tab-2" data-bs-target="#tab-2">내 강의 정보</a></li>
				<li class="lnb-item"><a class="nav-link" data-toggle="tab" href="#tab-3" data-bs-target="#tab-3">내 강의 정보</a></li>
			</ul>
		</aside>
		<article>
