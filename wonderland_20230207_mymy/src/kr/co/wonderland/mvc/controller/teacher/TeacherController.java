...
public class TeacherController {
	...
	public String teacherDetail(Model m, int tnum) {
		m.addAttribute("dto", teacherDaoInter.teacherDetail(tnum));
		m.addAttribute("dto2",teacherDaoInter.teacherDetail2(tnum));
		m.addAttribute("dto3",teacherDaoInter.teacherDetail3(tnum));
