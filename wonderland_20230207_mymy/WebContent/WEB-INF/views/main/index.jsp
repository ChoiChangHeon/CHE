...
<article>
	...
	<div class="main_teacher_zone" id="myTab">
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#kor" data-bs-target="#kor">국어</a></li>
			<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#eng" data-bs-target="#eng">영어</a></li>
			<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#math" data-bs-target="#math">수학</a></li>
		</ul>
